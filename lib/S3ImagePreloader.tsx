...
export async function listS3Bucket(shuffle: boolean = true) {
  //credentials...
  const creds = {
    accessKeyId: "AKIA6JULPL6JZPFLHBWC",
    secretAccessKey: "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",
  };

  // a client can be shared by different commands.
  const client = new S3Client({ region: "ap-northeast-1", credentials: creds });
  const params = {
